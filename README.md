...
## The data for the inventory and such is managed through a local Microsoft SQL database. In order to use this program as is, you will need to download the SQL files, put them in your project, and change the directory location to a local directory in your own location.
